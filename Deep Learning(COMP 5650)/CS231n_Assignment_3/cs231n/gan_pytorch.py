...
def discriminator_loss(logits_real, logits_fake):
    ...
    real_data_labels = torch.ones_like(logits_real)
    fake_data_labels = torch.zeros_like(logits_fake)

    real_data_loss = bce_loss(logits_real, real_data_labels.squeeze())
    fake_data_loss = bce_loss(logits_fake, fake_data_labels.squeeze())
...
def generator_loss(logits_fake):
    ...
    fake_data_labels = torch.ones_like(logits_fake)
    loss = bce_loss(logits_fake, fake_data_labels.squeeze())
